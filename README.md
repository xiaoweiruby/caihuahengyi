...
## 2017年12月19日 肖威
- 完成了前端页面的修改工作
- 思考如何更好的完成 index、show、edit、new 界面的代码的填充工作。
- 我们现在在完成网页页面布局的时候，主要依靠的是RMVC，就是所使用控制器完成代码的控制，实现数据的增删改查的同时完成用户的判断；
- 在这个时候，我们所欠缺的经验主要在于查看的案例太少，不知道别人是如何使用 ruby 完成的 views 前端代码的布局；
- 特别是对于 index 和 show 的界面，真正考验个体的其实是对于 new 和 edit 的界面的修改，如何实现博客式的内容填充方法，才是我们现在最应该掌握的核心的技能体系；


## 2017年12月20日 杨吉堂
- 修改qas/index增加条幅
- 修改employments/index超链接跳转至新的页面
